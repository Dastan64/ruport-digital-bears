# Тестовое задание для соискателя на должность frontend-разработчика от компании Ruport (лежит [в открытом доступе](https://github.com/Hexlet/ru-test-assignments))
